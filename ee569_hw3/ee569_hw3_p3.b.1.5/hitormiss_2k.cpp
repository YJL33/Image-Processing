...
#include "hitormiss_2k.h"

// This function applies stage 1 hit or miss filter.
unsigned char HitOrMiss2k(unsigned char arr[], int len)
{
    if (len <9) {
    ...
    // Spur
    if ((match == 0) && (arr[8] == 1) && (arr[0] == 0 && arr[1] == 0 && arr[2] == 0 && arr[3] == 0 && arr[5] == 0 && arr[6] == 0 && arr[7] == 0)) {
        match = 1;
        //printf("Spur\n");
    }
    if ((match == 0) && (arr[6] == 1) && (arr[0] == 0 && arr[1] == 0 && arr[2] == 0 && arr[3] == 0 && arr[5] == 0 && arr[7] == 0 && arr[8] == 0)) {
        match = 1;
        //printf("Spur\n");
    }
    ...
    if ((match == 0) && (arr[3] == 1) && (arr[0] == 0 && arr[1] == 0 && arr[2] == 0 && arr[5] == 0 && arr[6] == 0 && arr[7] == 0 && arr[8] == 0)) {
        match = 1;
        //printf("S-4\n");
    }
    if ((match == 0) && (arr[1] == 1) && (arr[0] == 0 && arr[2] == 0 && arr[3] == 0 && arr[5] == 0 && arr[6] == 0 && arr[7] == 0 && arr[8] == 0)) {
        match = 1;
        //printf("S-4\n");
    }
    ...
    if ((match == 0) && (arr[5] == 1 && arr[7] == 1 && arr[8] == 1)) {
        match = 1;
        //printf("Corner-Cluster\n");
    }
    
    // Tee branch
    if ((match == 0) && (arr[1] == 1 && arr[3] == 1 && arr[5] == 1)) {
        match = 1;
        //printf("Tee-branch\n");
    }
    if ((match == 0) && (arr[1] == 1 && arr[3] == 1 && arr[7] == 1)) {
        match = 1;
        //printf("Tee-branch\n");
    }
    if ((match == 0) && (arr[1] == 1 && arr[5] == 1 && arr[7] == 1)) {
        match = 1;
        //printf("Tee-branch\n");
    }
    if ((match == 0) && (arr[3] == 1 && arr[5] == 1 && arr[7] == 1)) {
        match = 1;
        //printf("Tee-branch\n");
    }
