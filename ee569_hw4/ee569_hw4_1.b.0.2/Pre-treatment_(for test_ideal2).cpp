...
//  HW4_P1.b.0.2
//
//  Label each connected objects (characters) in Test_ideal2.raw
...
//
//  Steps:
//  0. Read the image (250x400 24-bit)
...
int main(int argc, const char * argv[])
{
    clock_t begin = clock();
    FILE *file;
    int BytesPerPixel=3, Height = 400, Width = 250;               // Define the variables
    int boundary_box_width=224, boundary_box_height=245;            // The size of desired size of boundary box

    //argv[1] = "/Users/YJLee/Desktop/P4_Output/P1/Test_ideal2.raw"
    //argv[2] = "/Users/YJLee/Desktop/P4_Output/P1/test2/"
    //argv[3] = "/Users/YJLee/Desktop/P4_Output/P1/test2/Labeled.raw"  (if necessary)
    ...
    for (int y = 0; y < Height; ++y)
    {
        for (int x = 0; x < Width; ++x)
        {
            if ((x<20) || (x>Width-20) || (y<40) || (y>Height-40)) {
