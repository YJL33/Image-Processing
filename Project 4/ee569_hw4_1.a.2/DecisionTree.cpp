...
//
//  Input: [features array]......................... 2-D 10x18 array obtained from 1.1
//         directory of unknown image (224x245)
//
//  Min-dist. classifier:
...
int main(int argc, const char * argv[])
{
    ...
    // Step 2. Classify the unknown image
        
        /*
        double dist = 65536;            // Calculate the distance
        int character_guess = 19;
        for (int k=0; k<NumOfCharacter; ++k) {
            double dist_temp = 0;
            for (int ft=0; ft<NumberOfFeatures; ++ft) {
                dist_temp += pow((CharacterFeatures[ft][k] - Feature[ft][ch]), 2);
            }
        ...
        if (Feature[7][ch] == -1) {                // Euler number = -1
            ...
            if (Feature[11][ch] > 0.5) {           // Enclosed area are mostly distributed low
                printf("\n==============Guess: 6==============\n");
            }
            else
            {
                if (Feature[4][ch] > 0.9) {       // Enclosed area are bigger than pixel area
                    printf("\n==============Guess: 0==============\n");
                }
                else
                {
            ...
            else
            {
                if (Feature[6][ch] > 0.9) {            // This character is wide
                    ...
                    else if (Feature[8][ch] > 1) {     // The character is distributed more in rignt (3)
                        printf("\n==============Guess: 3==============\n");
                    }
                    else
                    {
