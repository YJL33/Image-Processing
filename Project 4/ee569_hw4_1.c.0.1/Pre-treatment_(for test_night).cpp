...
//  HW4_P1.c.0.1
//
//  Label each connected objects (characters) in Test_night_eq.raw
...
//
//  Steps:
//  0. Read the image (267x360 24-bit)
...
int main(int argc, const char * argv[])
{
    clock_t begin = clock();
    FILE *file;
    int BytesPerPixel=3, Height = 360, Width = 267;               // Define the variables
    int boundary_box_width=224, boundary_box_height=245;          // The size of desired size of boundary box

    //argv[1] = "/Users/YJLee/Desktop/P4_Output/P1/Test_night_eq.raw"
    //argv[2] = "/Users/YJLee/Desktop/P4_Output/P1/night/"
    //argv[3] = "/Users/YJLee/Desktop/P4_Output/P1/night/Labeled.raw"  (if necessary)
